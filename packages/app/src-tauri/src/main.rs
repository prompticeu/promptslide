...
fn main() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            // In dev mode, the Vite server is started by Tauri's beforeDevCommand.
            // The window automatically loads devUrl, so no navigation is needed.
