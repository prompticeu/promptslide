      ...
      <div className="flex h-full w-full flex-col items-center justify-center text-center">
        ...
        <div className="mb-12 w-full max-w-lg rounded-xl border border-border bg-card p-6">
          ...
          <div className="space-y-1 text-left font-mono text-sm">
            <p className="text-muted-foreground">$ npx create-slides my-pitch-deck</p>
            <p className="text-muted-foreground">$ cd my-pitch-deck && npm install</p>
            <p className="text-muted-foreground">$ npm run dev</p>
            <p className="text-green-400 mt-2">powervibe dev ready on http://localhost:5173</p>
          </div>
        </div>
